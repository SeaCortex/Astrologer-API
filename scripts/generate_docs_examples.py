...
def generate_examples():
    ...
    # 3. Natal Chart Data
    natal_data_payload = {"subject": subject_payload["subject"], "distribution_method": "weighted"}
    ...
    natal_chart_payload = {"subject": subject_payload["subject"], "theme": "classic", "split_chart": False}
    ...
    # 5. Now Subject
    now_subject_payload = {"name": "Current Sky", "zodiac_type": "Tropical", "houses_system_identifier": "P"}
    ...
    synastry_data_payload = {"first_subject": comp_payload["first_subject"], "second_subject": comp_payload["second_subject"], "include_house_comparison": True, "include_relationship_score": True}
    ...
    composite_data_payload = {"first_subject": comp_payload["first_subject"], "second_subject": comp_payload["second_subject"]}
    ...
    solar_return_data_payload = {"subject": subject_payload["subject"], "year": 2024, "wheel_type": "dual"}
    ...
    lunar_return_data_payload = {"subject": subject_payload["subject"], "year": 2024, "month": 5, "wheel_type": "single"}
    ...
    synastry_chart_payload = {"first_subject": comp_payload["first_subject"], "second_subject": comp_payload["second_subject"], "theme": "classic", "split_chart": False}
    ...
    composite_chart_payload = {"first_subject": comp_payload["first_subject"], "second_subject": comp_payload["second_subject"], "theme": "dark"}
    ...
    transit_chart_payload = {"first_subject": subject_payload["subject"], "transit_subject": transit_data_payload["transit_subject"], "theme": "classic"}
    ...
    solar_return_chart_payload = {"subject": subject_payload["subject"], "year": 2024, "wheel_type": "dual", "theme": "classic"}
    ...
    lunar_return_chart_payload = {"subject": subject_payload["subject"], "year": 2024, "month": 5, "wheel_type": "single", "theme": "classic"}
    ...
    # 20. Synastry Context
    synastry_context_payload = {"first_subject": comp_payload["first_subject"], "second_subject": comp_payload["second_subject"]}
    ...
    composite_context_payload = {"first_subject": comp_payload["first_subject"], "second_subject": comp_payload["second_subject"]}
    ...
    # 22. Transit Context
    transit_context_payload = {"first_subject": subject_payload["subject"], "transit_subject": transit_data_payload["transit_subject"]}
